...
def _draw_body(app: App) -> bool:
    ...
    # ONE decision per frame: the button and the key cannot both fire `on_confirm`. Enter is
    # declined on the appearing frame, which a keyboard menu activation shares with the press
    # that opened the modal (the bar draws before the popup block).
