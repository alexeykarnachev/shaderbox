...
ENGINE_UNIFORM_DOCS: dict[str, str] = {
    ...
    "u_resolution": "canvas size in pixels; the viewer's own size under Auto",
    ...
    return [
        ...
        HelpSection(
            ...
            body=(
                ...
                "or none, in the gear. On the graph tab a port exists because the shader "
                "declares a sampler that reads another pass, so a new pass has none until "
                "you add one, and `u_prev` never shows.\n"
                "\n"
